...
- The depth map with topic name `/zed2/zed_node/depth/depth_registered` and topic type `sensor_msgs/Image` are ready to be visualized in
rviz.
- An example rviz config can be found [here](configs\depth_map_zed2.rviz)
